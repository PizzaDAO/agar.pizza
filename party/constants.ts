...
// VARIATION: SLIPPERY - Ice-like physics, momentum-based movement
...
// Velocity decay - SLIPPERY VARIATION (the key change!)
export const VELOCITY_DECAY = 0.98; // CHANGED: very low friction! (was 0.92)
export const MIN_VELOCITY = 2; // CHANGED: slides longer (was 5)
